...
function Navbar() {
   ...
   const navList = useRef(null);
    ...
    const toggleBtn = () =>{
        console.log(navList.current.classList.toggle('hidden'));
    }
    ...
    return (
        <>
            ...
            <nav className='navbar bg-white-800 font-semibold font-Montserrat shadow flex flex-col justify-between lg:px-16 md:flex-row'>
                ...
                <ul className="navlist bg-gray-900 text-primary min-h-screen flex flex-col items-center justify-around py-40 md:flex md:flex-row md:min-h-0 md:py-2 md:bg-white md:text-black md:text-xs hidden" ref={navList}>
