...
function Navbar() {
   ...
   const navList = useRef(null);
    ...
    return (
        <>
            <div className='info hidden shadow text-xs justify-end px-4 pt-1 lg:px-32 text-brand md:font-semibold'>
            ...
            <nav className='navbar bg-white-800 font-semibold font-Montserrat shadow flex flex-col justify-between md:px-16 md:flex-row md:py-3 lg:py-1.5 lg:px-32'>
